package demo.multidatasource.configurations;

import com.zaxxer.hikari.HikariDataSource;
import demo.multidatasource.DemoApplication;
...
@EnableJpaRepositories(
        ...
        basePackages = {"demo.multidatasource.repository.writeRepository"}
)
public class DataSourceConfigWrite extends HikariConfigWrite {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactoryWrite(
        ...
        return new LocalContainerEntityManagerFactoryBean() {{
            ...
            setPackagesToScan(DemoApplication.MODEL_PACKAGE);
